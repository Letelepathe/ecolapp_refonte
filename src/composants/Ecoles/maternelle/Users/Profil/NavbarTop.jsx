            ...
            <div className="navbar-nav align-items-center ms-auto">
                ...
                <div className="nav-item dropdown">
                    <Link to="/maternelle/forum" className="nav-link">
                        <i className="bi bi-chat-fill me-lg-2 shadow" style={{ background: '#fff', borderRadius: '50px', color: '#1769ff', fontSize: '23px' }}></i>
                    </Link>
                </div>
                ...
                <div className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        <Link to={`/maternelle/mon_profil/${user.id}`} className="dropdown-item">
                            <i className="bi bi-person-circle text-primary"></i> Mon profil
                        </Link>
                        <Link to="/maternelle/deconnexion" className="dropdown-item">
