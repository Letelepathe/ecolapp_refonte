              ...
              <div className='shadow bg-white justify-content-center align-items-center py-2'>
                ...
                <div className="member-info text-center">
                  <img
                    ...
                    style={{ objectFit: 'cover', height:'80px', width:'80px', borderRadius:'50%' }}
                  />
                  <h6 style={{ color: '#1769ff' }}>{admin.first_name} {admin.name}</h6>
                  <a href={`tel:${admin.phone}`} className="btn btn-white w-100 mt-2 text-white" style={{background: '#1769ff', borderRadius : '10px'}}>Contacter</a>
                </div>
              </div>
            </div>
          ))}
