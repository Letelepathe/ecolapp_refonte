        ...
        <>
            ...
            <>
                                    ...
                                    <div className="menu">
                                        ...
                                        <div className={`dropdown-content ${openMenus['menu2'] ? 'open' : ''}`}>
                                            <Link to="/maternelle/ajouter_cours_by_enseignant" className="dropdown-item">
                                                <i className="bi bi-plus-circle me-2"></i>Ajouter cours
                                            </Link>
                                            <Link to="/maternelle/liste_cours_by_enseignant" className="dropdown-item">
                                                <i className="bi bi-folder me-2"></i>Mes cours fichiers
                                            </Link>
                                            <Link to="/maternelle/liste_cours_titulaire_by_enseignant" className="dropdown-item">
                                    ...
                                    <div className="menu">
                                        ...
                                        <div className={`dropdown-content ${openMenus['menu3'] ? 'open' : ''}`}>
                                            <Link to="/maternelle/select_classe_by_enseignant" className="dropdown-item">
                                                <i className="bi bi-upload me-2"></i>Déposer cote
                                            </Link>
                                            <Link to="/maternelle/select_classe_consulte_cote_by_enseignant" className="dropdown-item">
            ...
            <div className="menu">
                ...
                <>
                                                ...
                                                <Link to={`/maternelle/panel_eleve/${eleveInfo?.id}/${eleveInfo?.ecole_id}/${eleveInfo?.direction}`} className="dropdown-item">
                            ...
                            <Link to="/maternelle/deconnexion" className="nav-item nav-link text-white">
