    ...
    return(
        <div>
            <div class="container-fluid pt-4 px-4">
                <div class="  py-3 rounded-top p-4">
                    <div class="row">
            ...
            <div className="navbarbot">
                        <div className="ico">
                            <Link to="/maternelle/profil_user">
                        ...
                        <div className="ico">
                            <Link to="/maternelle/communiques">
                            <i className="bi bi-chat-text"></i> 
                            <div className="icon-title">Communiqués</div> 
                            </Link>
                        </div>
                        <div className="ico">
                            <Link to={`/maternelle/mon_profil/${id}`}>
                            <i className="bi bi-person-circle"></i> 
                            <div className="icon-title">Mon profil</div>
                            </Link>
                        </div>
                        <div className="ico">
                            <Link to="/maternelle/deconnexion">
