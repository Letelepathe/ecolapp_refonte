...
const SelectClasseConsulteCote = () => {
  ...
  useEffect(() => {
    const fetchClasses = async () => {
      try {
        const response = await axios.get('http://localhost/ecole-app/apis/getClasses');
  ...
  const handleSubmit = (e) => {
    ...
    setErrors('');
    navigate(`/maternelle/select_cours_periode_consulte_cote?classe_id=${selectedClasse}`);
  };
...
export default SelectClasseConsulteCote;
