      ...
      <div className="content">
        ...
        <div className="container mt-5">
          <div className="mt-2 mb-2 justify-content-between align-items-center d-flex">
            <Link to='/maternelle/bureau_admin' className='btn btn-warning text-white'>
              <i className="bi bi-arrow-left"></i> Retour
            </Link>
            <Link
              to={`/maternelle/cote_generale?classe_id=${classeId}&periode_id=${periodeId}&cours_id=${coursId}`}
