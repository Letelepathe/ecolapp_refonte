  ...
  useEffect(() => {
    ...
    const checkEleveSession = () => {
      if (!id && !ecole_id && !direction) {
        navigate('/maternelle/suivi_scolaire');
      }
    };
      ...
      <nav className="navbar hide-on-print navbar-light py-2 fixed-top container-fluid u-style-c69d0774">
          ...
          <div className="text-center">
            <div className="hide-on-print">
              {authenticated ?
            <Link className="btn  text-white  u-style-420aab4e" to="/maternelle/profil_user">
                Retour
              </Link> :

            <Link className="btn  text-white  u-style-420aab4e" to="/maternelle">Quitter</Link>
            }
            </div>
          </div>
      </nav>
      <div className="panel-eleve">
        ...
        <div className="u-style-5fa693f3">
          <div className="justify-content-between align-items-center d-flex hide-on-print mt-2 mb-2">
            ...
            <Link to={`/maternelle/consulter_resultat/${id}`} className="btn  text-white">Consulter résultat</Link>
          </div>
