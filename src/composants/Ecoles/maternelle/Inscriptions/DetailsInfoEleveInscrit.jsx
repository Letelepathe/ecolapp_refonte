...
const DetailsInfoEleveInscritmaternelle = () => {
  ...
  return (
    <main className="info-eleve-container">
      ...
      {/* Boutons */}
      <div className="text-center">
        <Link to="/maternelle" className="info-eleve-button info-eleve-btn-danger">Quitter cette page</Link>
...
export default DetailsInfoEleveInscritmaternelle;
