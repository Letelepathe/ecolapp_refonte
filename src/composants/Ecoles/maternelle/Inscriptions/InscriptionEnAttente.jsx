      ...
      <div className="content">
        ...
        <div className="container mt-3">
          <div className="justify-content-between align-items-center d-flex">
            <Link to='/maternelle/liste_eleve' className='btn btn-warning text-white'>Listes élèves</Link>
            <Link to='/maternelle/liste_eleve_inscrit_maternelle' className='btn btn-warning text-white'>Inscriptions confirmées</Link>
          ...
          <h2 className="text-center" style={{ color: '#1769ff' }}>Liste des Inscriptions du maternelle en attente</h2>
