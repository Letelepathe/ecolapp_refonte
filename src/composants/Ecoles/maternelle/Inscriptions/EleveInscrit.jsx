      ...
      <div className="content">
        ...
        <div className="container mt-3">
          <div className="justify-content-between align-items-center d-flex">
            ...
            <Link to='/maternelle/inscription_en_attente' className='btn btn-warning text-white'>Inscriptions en attente</Link>
          ...
          <h2 className="text-center" style={{ color: '#1769ff' }}>Liste des Élèves Inscrits au maternelle</h2>
