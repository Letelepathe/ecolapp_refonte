            ...
            <div className='bulletin-eleve'>
                <div className="bloc-bulletin">
                    ...
                    <div className="text-center py-2 mb-2 mt-2">
                        <button className="btn  hide-on-print" onClick={printBulletin}>Imprimer</button>
                    </div>
                    <div className="hide-on-print text-center mb-2 mt-2 py-2">
                        <Link className="btn  text-white " to={authenticated ? "/secondaire/profil_user" : "/secondaire"}>Retour</Link>
                    </div>
                </div>
            </div>
        </div>
