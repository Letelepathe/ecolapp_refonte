...
const SelectInfo = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedOption === 'periodique') {
      navigate(`/maternelle/consulter_resultat_periodique?eleve_id=${id_eleve}`);
    } else if (selectedOption === 'semestriel') {
      navigate(`/maternelle/consulter_resultat_semestriel?eleve_id=${id_eleve}`);
    } else if (selectedOption === 'annuel') {
      navigate(`/maternelle/consulter_resultat_annuel?eleve_id=${id_eleve}`);
    }
  };
