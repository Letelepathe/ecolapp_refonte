...
const SelectSemestreAnnee = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const [anneeResponse, semestreResponse] = await Promise.all([
        ...
        setSemestres(semestreResponse.data.semestreAll || []);
  ...
  const handleSubmit = (e) => {
    ...
    setErrors('');
    navigate(`/maternelle/resultat_semestriel?eleve_id=${id_eleve}&semestre_id=${selectedSemestre}&annee_id=${selectedAnnee}`);
  };
...
export default SelectSemestreAnnee;
