        ...
        <NavbarTop />
          <div className="container mt-5">
            ...
            <div className="mt-2 mb-2 justify-content-between align-items-center d-flex">
                <Link to='/maternelle/profil_user' className='btn btn-warning text-white'>
                  <i className="bi bi-arrow-left"></i> Retour
                </Link>
                
                <Link
                  to={`/maternelle/cote_generale?classe_id=${classeId}&option_id=${optionId}&periode_id=${periodeId}&cours_id=${coursId}`}
                  className="btn btn-primary"
                >
                  Note générale
                </Link>
                <Link
                  to={`/maternelle/deliberation?classe_id=${classeId}&option_id=${optionId}&periode_id=${periodeId}&cours_id=${coursId}`}
