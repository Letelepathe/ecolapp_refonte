...
const SelectTypeCoteConsulte = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedOption === 'periode') {
      navigate(`/maternelle/select_periode_consulte_cote?cours_id=${coursId}&classe_id=${classeId}&option_id=${optionId}`);
    } else if (selectedOption === 'examen') {
      navigate(`/maternelle/select_semestre_consulte_cote?cours_id=${coursId}&classe_id=${classeId}&option_id=${optionId}`);
    }
  };
