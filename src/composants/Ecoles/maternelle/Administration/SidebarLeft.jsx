        ...
        <nav className="navbar navbar-white" style={{ background: "#1769ff" }}>
          ...
          <div className="navbar-nav w-100">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/creer_admin" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Créer admin
                </Link>
                <Link to="/maternelle/creer_super_admin" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Créer super admin
                </Link>
                <Link to="/maternelle/suspendre_admin" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/ajouter_annee_scolaire" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une année
                </Link>
                <Link to="/maternelle/liste_annee_scolaire" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Toutes les années
                </Link>
                <Link to="/maternelle/ajouter_semestre" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter un semestre
                </Link>
                <Link to="/maternelle/liste_semestre" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Tous les semestres
                </Link>
                <Link to="/maternelle/ajouter_periode" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une période
                </Link>
                <Link to="/maternelle/liste_periode" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/liste_communique" className="dropdown-item">
                  <i className="bi bi-envelope-open me-2"></i>Listes communiqués
                </Link>
                <Link to="/maternelle/lancer_communique" className="dropdown-item">
                  <i className="bi bi-send-fill me-2"></i>Lancer un communiqué
                </Link>
                <Link to="/maternelle/liste_contact" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/creationcompte" className="dropdown-item">
                  <i className="bi bi-person-plus-fill me-2"></i>Ajouter enseignant
                </Link>
                <Link to="/maternelle/liste_enseignant" className="dropdown-item">
                  <i className="bi bi-people-fill me-2"></i>Tous les enseignants
                </Link>
                <Link to="/maternelle/ajouter_titulaire" className="dropdown-item">
                  <i className="bi bi-person-plus-fill me-2"></i>Ajouter titulaire classe
                </Link>
                <Link to="/maternelle/liste_titulaire" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/ajouter_eleve" className="dropdown-item">
                  <i className="bi bi-person-plus-fill me-2"></i>Ajouter un élève
                </Link>
                <Link to="/maternelle/liste_eleve" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Tous les élèves
                </Link>
                <Link to="/maternelle/cartes_eleves" className="dropdown-item">
                  <i className="bi bi-credit-card-2-front-fill me-2"></i>Cartes élèves
                </Link>
                <Link to="/maternelle/liste_eleve_inscrit_maternelle" className="dropdown-item">
                  <i className="bi bi-journal-richtext me-2"></i>Élèves inscrits
                </Link>
                <Link to="/maternelle/ajouter_motif_absence" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter motif paiement
                </Link>
                <Link to="/maternelle/liste_motif_absence" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Listes motifs absence 
                </Link>
                <Link to="/maternelle/ajouter_type_travail" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter type travail 
                </Link>
                <Link to="/maternelle/liste_type_travail" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/ajouter_cours" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter un cours
                </Link>
                <Link to="/maternelle/liste_cours" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Tous les cours
                </Link>
                <Link to="/maternelle/liste_cours_enseigne" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/ajouter_motif" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter motif paiement
                </Link>
                <Link to="/maternelle/liste_motif" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Listes motif
                </Link>
                <Link to="/maternelle/ajouter_tranche" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter tranche 
                </Link>
                <Link to="/maternelle/liste_tranche" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Listes tranche
                </Link>
                <Link to="/maternelle/ajouter_mode_paiement" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter un mode
                </Link>
                <Link to="/maternelle/liste_mode_paiement" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Tous les modes
                </Link>
                <Link to="/maternelle/ajouter_devise" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une dévise
                </Link>
                <Link to="/maternelle/liste_devise" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Listes dévise
                </Link>
                <Link to="/maternelle/ajouter_paiement" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter un paiement
                </Link>
                <Link to="/maternelle/liste_paiement" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/ajouter_classe" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une Classe
                </Link>
                <Link to="/maternelle/liste_classe" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Toutes les classes
                </Link>
                <Link to="/maternelle/ajouter_section" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une section
                </Link>
                <Link to="/maternelle/liste_section" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Toutes les sections
                </Link>
                <Link to="/maternelle/ajouter_option" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une option
                </Link>
                <Link to="/maternelle/liste_options" className="dropdown-item">
            ...
            <div className="menu">
              ...
              >
                <Link to="/maternelle/ajouter_fonction" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Ajouter une fonction
                </Link>
                <Link to="/maternelle/liste_fonction" className="dropdown-item">
                  <i className="bi bi-list-check me-2"></i>Toutes les fonctions
                </Link>
                <Link to="/maternelle/creationcompte" className="dropdown-item">
                  <i className="bi bi-plus me-2"></i>Créer utilisateur
                </Link>
                <Link to="/maternelle/membres_inscrits" className="dropdown-item">
