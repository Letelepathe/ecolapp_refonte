...
const AjouterTrimestre = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://api.ecolapp.cd/api/semestre/create', formData, {
            ...
            <div className="col-lg-6 col-md-8">
              <div className="card mb-3">
                <div className="d-flex align-items-center justify-content-between">
                 <h6 className="text-center" style={{ fontWeight: 900, color: '#1769ff' }}>Ajouter trimestre</h6>
                 <Link to='/maternelle/liste_trimestre' className='btn btn-warning text-white'>Liste trimestres</Link>
                </div>
...
export default AjouterTrimestre;
