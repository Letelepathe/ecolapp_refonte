      ...
      <div className="content">
        ...
        <div className="container mt-3">
          <div className="justify-content-between align-items-center d-flex">
            <Link to='/secondaire/liste_eleve' className='btn  text-white'>Listes élèves</Link>
            <Link to='/secondaire/inscription_en_attente' className='btn  text-white'>Inscriptions en attente</Link>
          ...
          <h2 className="text-center u-style-43ef163a">Liste des Élèves Inscrits au secondaire</h2>
...
export default EleveInscritsecondaire;
