      ...
      <div className="content">
        ...
        <div className="container mt-3">
          <div className="justify-content-between align-items-center d-flex">
            ...
            <Link to='/secondaire/liste_eleve_inscrit_secondaire' className='btn  text-white'>Inscriptions confirmées</Link>
          ...
          <h2 className="text-center u-style-43ef163a">Liste des Inscriptions du secondaire en attente</h2>
