...
const InfoEleveInscritsecondaire = () => {
  ...
  return (
    <main className="info-eleve-container">
      ...
      {/* Boutons */}
      <div className="text-center">
        <Link to="/secondaire" className="info-eleve-button info-eleve-">Quitter cette page</Link>
...
export default InfoEleveInscritsecondaire;
