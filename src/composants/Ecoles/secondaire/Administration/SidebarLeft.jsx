          ...
          <div className="navbar-nav w-100">
            ...
            <div className="menu">
              ...
              >
                ...
                <Link to="/secondaire/cartes_eleves" className="dropdown-item">
            ...
            <div className="menu">
              <div className="menu-header" onClick={() => toggleMenu("menu6")}>
                <i className="bi bi-eject-fill me-2"></i>Cours & Horaires
              ...
              >
                ...
                <Link to="/secondaire/generer_horaire" className="dropdown-item">
                  <i className="bi bi-plus-circle-fill me-2"></i>Générer horaire
                </Link>
              </div>
            </div>
