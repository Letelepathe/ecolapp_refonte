          ...
          <section className="section d-flex flex-column align-items-center justify-content-center py-4">
            <div className="col-lg-6 col-md-8">
              <div className="card mb-3">
                <Link to='/secondaire/liste_devise' className='btn btn-primary mb-2 mt-2'>Liste devises</Link>
                <div className="card-body">
                  <h3 className="text-center" style={{ fontWeight: 900, color: '#1769ff' }}>Ajouter Devise</h3>
