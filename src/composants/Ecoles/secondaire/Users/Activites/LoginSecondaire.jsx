  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        ...
        navigate('/secondaire/profil_user'); // Naviguer vers la page du profil utilisateur
      } else {
                ...
                <div className="card-body">
                  ...
                  <form onSubmit={handleSubmit} className="row g-3 needs-validation user_activity">
                    ...
                    <div className="col-12 text-center">
                      <p className="small mb-0">Nouveau ici? <Link to="/secondaire/alert_creation_compte" className="btn btn-success">Créer un compte</Link></p>
                    </div>
                  </form>
                </div>
              </div>
