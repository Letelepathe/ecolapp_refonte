...
const CreationCompte = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        ...
        setErrors({});
        navigate(`/secondaire/pre_connexion/${response.data.last_id}`);
      } else {
  ...
  return (
    <div>
      <Helmet>
        <title>Secondaire | Création compte</title>
              ...
              <div className="card-body">
                ...
                <form onSubmit={handleSubmit} className="user_activity" encType="multipart/form-data">
                  ...
                  {errors.form &&
                    ...
                    <div className="col-12">
                      <button
                        className={`${`btn btn-white w-100 ${isLoading ? "loading" : ""}`} style-fr-557a21f1`}
