  ...
  return (
    <div className="container mt-4">
      <div className="d-flex align-items-center justify-content-between">
        ...
        <Link className="btn btn-primary" to='/secondaire/ajouter_cours_by_enseignant'> <i className="bi bi-plus"></i> Ajouter cours</Link>
      </div>
      {successMessage &&
      <p>{successMessage}</p>
      }
    ...
    <div>
       <div className="container mt-4">
          <div className="justify-content-between align-items-center d-flex">
            ...
            <Link className="btn btn-primary" to='/secondaire/ajouter_travail_by_enseignant'> <i className="bi bi-plus"></i> Ajouter travail</Link>
          </div>
          {successMessage &&
        <p>{successMessage}</p>
        }
    ...
    <div>
            ...
            <div className="container-fluid position-relative bg-white d-flex p-0">
              ...
              <>
                            ...
                            <div className="col-sm-6 col-md-6 col-xl-3">
                                {/* Communiqués accessibles à tous */}
                              <Link to='/secondaire/communiques' target="_blank" rel="noopener noreferrer">
              ...
              <div className='col-12'>
                ...
                <>
                                  <div className="col-12 mb-1 mt-1 mb-2">
                                    <div className="bg-white rounded align-items-center justify-content-center p-4">
                ...
                <>
                      ...
                      <p> {successMessage} </p>
                          ...
                          <div className="col-lg-12 col-12">
                            <div className="col-12 mb-1 mt-1">
                                <div className="bg-white  rounded align-items-center justify-content-center p-1">
                                 <Communiques />
                                </div>
                            </div>
                            <div className="col-12 mb-1 mt-1">
