...
const AfficherResultatAnnuel = () => {
            ...
            try {
                ...
                if (response.data.status === 200) {
                     setBulletinInfo({
                       ...
                       dataSemestres : response.data.data_semestres,
                       coursGroupes : response.data.cours_groupes,
                       totalAnnuel : response.data.total_annuel,
                       anneeScolaire : response.data.annee_scolaire,
                       pourcentageAnnuel : response.data.pourcentage_annuel
    ...
    if (!bulletinInfo.eleveInfo || !bulletinInfo.dataSemestres || !ecole) {
