            ...
            <div className="col-lg-4" key={communique.id} style={styles.cardContainer}>
              <div className="post-box" style={styles.card}>
                ...
                <div className="text-center">
                  <Link className="btn btn-white text-white w-100" style={{background : '#1769ff'}} to={`/secondaire/details-communique/${communique.id}`}>Lire plus <i className="bi bi-arrow-right"></i> </Link>
                </div>
              </div>
            </div>
          ))}
