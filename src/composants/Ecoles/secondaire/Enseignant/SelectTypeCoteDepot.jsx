...
const SelectTypeCoteDepot = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedOption === 'periode') {
      navigate(`/secondaire/ajouter_cote_periode_by_enseignant?classe_id=${classeId}&option_id=${optionId}`);
    } else if (selectedOption === 'examen') {
      navigate(`/secondaire/ajouter_cote_examen_by_enseignant?classe_id=${classeId}&option_id=${optionId}`);
    }
  };
