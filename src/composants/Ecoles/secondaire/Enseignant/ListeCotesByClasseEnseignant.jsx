        ...
        <NavbarTop />
          <div className="container mt-5">
            ...
            <div className="mt-2 mb-2 justify-content-between align-items-center d-flex">
                ...
                <Link
                  to={`/secondaire/cote_generale?classe_id=${classeId}&option_id=${optionId}&periode_id=${periodeId}&cours_id=${coursId}`}
                  className="btn btn-primary"
                >
                  Note générale
                </Link>
                <Link
                  to={`/secondaire/deliberation?classe_id=${classeId}&option_id=${optionId}&periode_id=${periodeId}&cours_id=${coursId}`}
