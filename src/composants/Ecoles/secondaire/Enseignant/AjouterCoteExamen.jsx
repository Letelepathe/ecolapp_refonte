  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        ...
        navigate(`/secondaire/liste_cote_examen_classe_by_enseignant?classe_id=${classeId}&option_id=${optionId}&semestre_id=${e.target.semestre.value}&cours_id=${e.target.cours.value}`);
      } else {
