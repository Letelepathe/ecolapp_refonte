...
const DeposerInterrogation = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://cria.com/deposer-interrogation.php', form, {
        headers: {
      ...
      if (response.data.success) {
        setSuccessMessage("L'interrogation a été déposée avec succès !");
        setFormData({ classe: '', fichier: null });
        setFileName('');
        setErrors({});
      } else {
        setErrorMessage("Une erreur s'est produite lors du dépôt de l'interrogation.");
      }
    } catch (error) {
      setErrorMessage("Impossible de déposer l'interrogation pour le moment.");
    }
  };
              ...
              <div className="col-lg-8 col-md-10 d-flex flex-column align-items-center justify-content-center">
                <div className="card mb-3">
                  <div className="card-body">
                    <h5 className="card-title text-center text-primary pb-0 fs-4">Déposer une Interrogation</h5>
...
export default DeposerInterrogation;
