...
const SelectTypeCoteDepot = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedOption === 'periode') {
      navigate(`/primaire/ajouter_cote_periode_by_enseignant?classe_id=${classeId}&option_id=${optionId}`);
    } else if (selectedOption === 'examen') {
      navigate(`/primaire/ajouter_cote_examen_by_enseignant?classe_id=${classeId}&option_id=${optionId}`);
    }
  };
