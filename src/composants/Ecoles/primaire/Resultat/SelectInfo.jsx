...
const SelectInfo = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (selectedOption === 'periodique') {
      navigate(`/primaire/consulter_resultat_periodique?eleve_id=${id_eleve}`);
    } else if (selectedOption === 'semestriel') {
      navigate(`/primaire/consulter_resultat_semestriel?eleve_id=${id_eleve}`);
    } else if (selectedOption === 'annuel') {
      navigate(`/primaire/consulter_resultat_annuel?eleve_id=${id_eleve}`);
    }
  };
