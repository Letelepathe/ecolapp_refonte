      ...
      <div className="row">
        <div className="col-md-12">
          <div className="forum-header d-flex justify-content-between align-items-center mb-4">
            <h2>Forum</h2>
            <Link to="/primaire/forum/start-discussion" className="btn btn-primary">Créer topic</Link>
            <Link className='btn btn-dark' to='/primaire/profil_user'>Quitter</Link>
          </div>
          ...
          <div className="list-group">
            {filteredTopics.length > 0 ? (
              filteredTopics.map(topic => (
                <Link 
                  key={topic.id} 
                  to={`/primaire/forum/discussion/${topic.id}`} 
