              ...
              <div className=" py-3  mt-2 mb-2 u-style-59f7bcd2">
                  <div className="container">
                    ...
                    <div className="justify-content-center aling-items-center d-flex">
                      <Link to={`/primaire/ajouter_presence_eleve/${id_classe}/${id_option}`} className="btn  w-50 u-style-9761b3f7">Ajouter</Link>
                      <Link to={`/primaire/historique_presence_eleve/${id_classe}/${id_option}`} className="btn  text-white w-50">Historique</Link>
                    </div>
                  </div>
                </div>
              }
                      ...
                      <tbody>
                        ...
                        <tr key={travail.id}>
                          ...
                          <td>
                              ...
                              <Link to={`/primaire/deposer_travail_by_eleve/${travail.id_cours}/${travail.id}`} className="btn  w-100 mb-2 mt-2">
                                Déposer mon travail
                              </Link>
                              </td>
                          }
                              {user && (user.fonction.name === 'Enseignant' || user.fonction.name === 'Enseignante' || user.fonction.name === 'Administrateur' || user.fonction.name === 'Super Administrateur' || user.fonction.name === 'Administratrice' || user.fonction.name === 'Super Administratrice') &&
                          <td>
                                  <Link to={`/primaire/liste_travaux_deposes/${travail.id}`} target="_blank" rel="noopener noreferrer" className="btn  text-white">
                      ...
                      <tbody>
                        ...
                        <tr key={eleve.id}>
                          ...
                          <td>{eleve.matricule}</td>
                            ...
                            {user && (user.fonction.name === 'Enseignant' || user.fonction.name === 'Enseignante' || user.fonction.name === 'Administrateur' || user.fonction.name === 'Super Administrateur' || user.fonction.name === 'Administratrice' || user.fonction.name === 'Super Administratrice') &&
                          <td>
                                <Link target="_blank" rel="noopener noreferrer" to={`/primaire/consulter_resultat/${eleve.id}`} className="btn ">Résultats</Link>
                              </td>
                          }
                          </tr>
                        )}
