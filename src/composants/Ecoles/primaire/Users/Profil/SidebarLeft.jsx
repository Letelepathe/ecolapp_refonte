            ...
            <nav className="navbar navbar-white" style={{ background: '#1769ff', color: '#fff' }}>
                ...
                <div className="d-flex align-items-center ms-4 mb-4 w-100">
                    <div className="position-relative">
                        <Link to={`/primaire/mon_profil/${user.id}`}>
                            <img
                ...
                {isLoading ? (
                    ...
                    <>
                        <div className="navbar-nav w-100">
                            ...
                            <Link to="/primaire/profil_user" className="nav-item nav-link active text-white">
                            ...
                            {(ROLES_ADMIN.includes(user?.fonction?.name) || ROLES_ADMIN.includes(user?.role)) && (
                                <Link to="/primaire/bureau_admin" className="nav-item nav-link text-white">
                                    <img src={ImageEvent}
                                ...
                                <div className="menu">
                                    ...
                                    <div className={`dropdown-content ${openMenus['menu1'] ? 'open' : ''}`}>
                                        {infoClasseUser?.map(classe => (
                                            <Link
                                                to={`/primaire/ma_classe/${classe?.classe?.id}/${classe?.option?.id}`}
                                ...
                                <>
                                    ...
                                    <div className="menu">
                                        ...
                                        <div className={`dropdown-content ${openMenus['menu2'] ? 'open' : ''}`}>
                                            <Link to="/primaire/ajouter_cours_by_enseignant" className="dropdown-item">
                                                <i className="bi bi-plus-circle me-2"></i>Ajouter cours
                                            </Link>
                                            <Link to="/primaire/liste_cours_by_enseignant" className="dropdown-item">
                                                <i className="bi bi-folder me-2"></i>Mes cours fichiers
                                            </Link>
                                            <Link to="/primaire/liste_cours_titulaire_by_enseignant" className="dropdown-item">
                                    ...
                                    <div className="menu">
                                        ...
                                        <div className={`dropdown-content ${openMenus['menu3'] ? 'open' : ''}`}>
                                            <Link to="/primaire/select_classe_by_enseignant" className="dropdown-item">
                                                <i className="bi bi-upload me-2"></i>Déposer cote
                                            </Link>
                                            <Link to="/primaire/select_classe_consulte_cote_by_enseignant" className="dropdown-item">
                            ...
                            <div className="menu">
                                ...
                                <div className={`dropdown-content ${openMenus['menu4'] ? 'open' : ''}`}>
                                    ...
                                    {ROLES_TEACHER.includes(user?.fonction?.name) && (
                                        <Link to="/primaire/ajouter_travail_by_enseignant" className="dropdown-item">
                                            <i className="bi bi-plus-circle me-2"></i>Ajouter travail
                                        </Link>
                                    )}

                                    {(user?.fonction?.name === "Elève" || user?.role === "Elève") && (
                                        <Link to="/primaire/liste_travail_by_eleve" className="dropdown-item">
                                            <i className="bi bi-folder me-2"></i>Mes travaux
                                        </Link>
                                    )}

                                    {ROLES_TEACHER.includes(user?.fonction?.name) && (
                                        <Link to="/primaire/liste_travail_by_enseignant" className="dropdown-item">
                                            <i className="bi bi-folder me-2"></i>Mes travaux
                                        </Link>
                                    )}
                                ...
                                <div className="menu">
                                    ...
                                    <div className={`dropdown-content ${openMenus['menu5'] ? 'open' : ''}`}>
                                        ...
                                        {!isLoadingEleveInfo && eleveInfo && (
                                            <>
                                                <Link to={`/primaire/ma_classe/${eleveInfo?.classes_id}/${eleveInfo?.options_id}`} className="dropdown-item">
                                                    <i className="bi bi-folder me-2"></i>Ma classe
                                                </Link>

                                                <Link to={`/primaire/panel_eleve/${eleveInfo?.id}/${eleveInfo?.ecole_id}/${eleveInfo?.direction}`} className="dropdown-item">
                            ...
                            <Link to="/primaire/deconnexion" className="nav-item nav-link text-white">
