              ...
              <div className="card mb-3">
                <div className="card-body">
                  <div className="justify-content-between align-items-center d-flex">
                    ...
                    <Link to='/primaire/ajouter_mode_paiement' className='btn  mb-2 mt-2'>Ajouter</Link>
                  </div>
                </div>
                <div className="table-responsive">
                    <Link to='/primaire/ajouter_mode_paiement' className="btn  mb-2 mt-2">Ajouter mode</Link>
                    {successMessage && ( 
                        <p> {successMessage} </p>
                    )}
                    {error ? (
