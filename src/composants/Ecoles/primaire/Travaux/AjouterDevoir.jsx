...
const AjouterDevoir = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://cria.com/ajouter-devoir.php', form, {
        headers: {
      ...
      if (response.data.success) {
        setSuccessMessage("Le devoir a été ajouté avec succès !");
        setFormData({ classe: '', sujet: '', fichier: null, description: '' });
        setFileName('');
        setErrors({});
      } else {
        setErrorMessage("Une erreur s'est produite lors de l'ajout du devoir.");
      }
    } catch (error) {
      setErrorMessage("Impossible d'ajouter le devoir pour le moment.");
    }
  };
              ...
              <div className="col-lg-8 col-md-10 d-flex flex-column align-items-center justify-content-center">
                <div className="card mb-3">
                  <div className="card-body">
                    <h5 className="card-title text-center text-primary pb-0 fs-4">Ajouter un Devoir</h5>
