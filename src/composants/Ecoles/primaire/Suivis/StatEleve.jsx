...
import {
  ...
  XAxis, YAxis, Tooltip, Legend, ResponsiveContainer, LineChart, Line
} from 'recharts';
    ...
    <div className="w-full p-4  rounded-lg">
      ...
      <div className="row">
        {statPresence.length > 0 && (
          <div style={{ height: 300 }} className="col-lg-6 col-sm-6 col-12 mb-3 mt-3 chart-wrapper">
       ...
       {statPaiement.length > 0 && (
          <div style={{ height: 300 }} className="col-lg-6 col-12 mb-3 mt-3 chart-wrapper">
        ...
        {statTravail.length > 0 && (
          <div style={{ height: 300 }} className="col-12 mb-3 mt-3 chart-wrapper-2">
