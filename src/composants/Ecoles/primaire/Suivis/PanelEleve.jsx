  ...
  useEffect(() => {
    ...
    const checkEleveSession = () => {
      if (!id && !ecole_id && !direction) {
          navigate('/primaire/suivi_scolaire');
      }
    };
      ...
      <nav className="navbar hide-on-print navbar-light py-2 fixed-top container-fluid" style={{background: '#fff'}}>
          ...
          <div className="text-center">
            <div className="hide-on-print">
              {authenticated ? (
              <Link className="btn btn-warning text-white btn-sm" style={{borderRadius:'10px'}} to="/primaire/profil_user">
                Retour
              </Link>
              ) : (
                <Link className="btn btn-warning text-white btn-sm" style={{borderRadius:'10px'}} to="/primaire">Quitter</Link>
              )}
            </div>
          </div>
      </nav>
      <div className="panel-eleve">
        ...
        <div className="" style={{marginTop: '20px'}}>
          <div className="justify-content-between align-items-center d-flex hide-on-print mt-2 mb-2">
            ...
            <Link to={`/primaire/consulter_resultat/${id}`} className="btn btn-warning text-white">Consulter résultat</Link>
          </div>
          <div className="row hide-on-print">
              <div className="col-lg-4 col-12 mt-1 mb-1">
                <div className="box" style={{ padding: "20px", borderRadius: "10px", background: "white", boxShadow: "0 4px 8px rgba(0, 0, 0, 0.1)" }}>
                    ...
                    <ul className="info-list container hide-on-print" style={{ listStyle: "none", padding: 0 }}>
                        ...
                        <li><i className="bi bi-gender-ambiguous"></i> <strong>Sexe:</strong> {eleve.sexe}</li>
                        <li><i className="bi bi-geo-alt"></i> <strong>Lieu de naissance:</strong> {eleve.lieu_de_naissance}</li>
                        <li><i className="bi bi-calendar"></i> <strong>Date de naissance:</strong> {eleve.date_naissance}</li>
                        <li><i className="bi bi-house"></i> <strong>Adresse:</strong> {eleve.adresse}</li>
                        <li><i className="bi bi-book"></i> <strong>Classe:</strong> {eleve.classe.name}</li>
                        <li><i className="bi bi-hash"></i> <strong>Matricule:</strong> {eleve.matricule}</li>
                    </ul>
                </div>
              </div>
