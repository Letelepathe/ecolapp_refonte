  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        ...
        navigate("/primaire/liste_communique");
      } else {
          ...
          <section className="section d-flex flex-column align-items-center justify-content-center py-4">
            <div className="col-lg-6 col-md-8">
              <div className="card mb-3">
                <Link to='/primaire/liste_communique' className="btn  mb-2 mt-2">Liste communiqués</Link>
                <div className="card-body">
                  ...
                  <form className="needs-validation" onSubmit={handleSubmit} noValidate>
                    ...
                    <div className="d-grid">
                      <button className={`${`btn  w-100 ${isLoading ? "loading" : ""}`} style-fr-1cda1bca`} type="submit"
                      disabled={isLoading}>
