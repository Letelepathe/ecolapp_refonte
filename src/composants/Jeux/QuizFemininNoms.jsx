...
const QuizFemininNoms = () => {
  ...
  function genererQuestion() {
    const questions = [
      { texte: "Le féminin de 'ami' est ___.", reponse: "amie", options: ["amie", "amis", "amies", "amicale", "amical"] },
      { texte: "Le féminin de 'acteur' est ___.", reponse: "actrice", options: ["actrice", "acteurs", "actrices", "acteur", "acteurial"] },
      { texte: "Le féminin de 'chanteur' est ___.", reponse: "chanteuse", options: ["chanteuse", "chanteurs", "chanteuses", "chantant", "chanteur"] },
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100">
      <div className="card p-4 shadow">
        <h1 className="text-center mb-4">Quiz Féminin des Noms</h1>
...
export default QuizFemininNoms;
