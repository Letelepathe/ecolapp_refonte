...
const QuizConjugaison = () => {
  ...
  function genererQuestion() {
    const questions = [
      { texte: "Conjuguez le verbe 'être' au présent : 'nous ___'.", reponse: "sommes", options: ["sommes", "êtes", "sont", "suis", "es"] },
      { texte: "Conjuguez le verbe 'avoir' au passé composé : 'ils ont ___'.", reponse: "eu", options: ["eu", "eue", "eus", "eues", "ayant"] },
      { texte: "Conjuguez le verbe 'aller' au futur : 'tu ___'.", reponse: "iras", options: ["iras", "ira", "irons", "irez", "irai"] },
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100">
      <div className="card p-4 shadow">
        <h1 className="text-center mb-4">Quiz Conjugaison</h1>
...
export default QuizConjugaison;
