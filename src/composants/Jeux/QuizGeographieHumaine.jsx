...
const QuizGeographieHumaine = () => {
  ...
  function genererQuestion() {
    const questions = [
      { texte: "Quelle est la langue la plus parlée en Amérique du Sud ?", reponse: "Espagnol", options: ["Espagnol", "Portugais", "Français", "Anglais", "Quechua"] },
      { texte: "Quel pays a la plus grande densité de population ?", reponse: "Bangladesh", options: ["Bangladesh", "Inde", "Chine", "Indonésie", "Japon"] },
      { texte: "Quelle est la capitale culturelle de l'Australie ?", reponse: "Melbourne", options: ["Melbourne", "Sydney", "Brisbane", "Perth", "Adélaïde"] },
  ...
  return (
    <div className="container d-flex justify-content-center align-items-center vh-100">
      <div className="card p-4 shadow">
        <h1 className="text-center mb-4">Quiz Géographie Humaine</h1>
...
export default QuizGeographieHumaine;
