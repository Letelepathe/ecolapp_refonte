        ...
        <nav className="navbar my-navbar navbar-expand bg-white navbar-white px-4 py-0" style={{ position: 'sticky', top: 0, zIndex: 1020 }}>
            ...
            <div className="navbar-nav align-items-center ms-auto">
                ...
                <div className="nav-item dropdown">
                    <Link to="/admin-general/bureau_admin" className="nav-link">
               ...
               {/* Icone de profil */}
                <div className="nav-item dropdown">
                    <Link to="/admin-general/profil_admin" className="nav-link">
                        <i className="bi bi-person-circle me-lg-2 shadow" style={{ background: '#fff', borderRadius: '50px', color: '#1769ff', fontSize: '23px' }}></i>
                    </Link>
                </div>
               
                <div className="nav-item dropdown">
                    <Link to="/admin-general/deconnexion" className="nav-link">
                        <i className="bi bi-box-arrow-right me-lg-2 shadow" style={{ background: '#fff', borderRadius: '50px', color: '#1769ff', fontSize: '23px' }}></i>
                    </Link>
                </div>
                ...
                <div className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
                        <div>
                            <Link to={`/adminGeneral/profil_admin/${user.id}`} className="dropdown-item">
                                <i className="bi bi-person-circle text-primary"></i> Mon profil
                            </Link>
                        </div>
                        <div>
                            <Link to="/adminGeneral/deconnexion" className="dropdown-item">
