  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (response.data.status === 200) {
        ...
        setErrors("Administrateur créé avec succès.");
            ...
            <div className="col-lg-8 col-12 card mb-3">
              <div className="card-body">
                ...
                <p className="text-center small">
                  Veuillez créer trois administrateurs en chosissant chaque fois une direction spécifique.
                </p>
                <form onSubmit={handleSubmit} className="user_activity" encType="multipart/form-data">
                  ...
                  {errors.form &&
                    ...
                    <div className="col-12">
                      <button
                        className={`${`btn btn-white w-100 ${isLoading ? "loading" : ""}`} style-fr-7ac2859a`}

                        type="submit"
                        disabled={isLoading}>
                        
                        {isLoading ? "Inscription en cours..." : "Créer admin"}
                      </button>
                    </div>
...
export default CreerSuperAdminEcole;
